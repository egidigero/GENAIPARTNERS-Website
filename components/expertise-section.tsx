  ...
  const benefits = [
    {
      ...
      description: "Menos tareas manuales, más foco en lo importante.",
      color: "from-blue-500 to-cyan-500",
    },
    {
      icon: <TrendingUp className="w-6 h-6" />,
      title: "Mayor ROI",
      description: "Inversión que se paga sola gracias a procesos más eficientes y ventas potenciadas.",
      color: "from-emerald-500 to-green-500",
    },
    {
      icon: <DollarSign className="w-6 h-6" />,
      title: "Reducción de costos",
      description: "Menos horas de trabajo operativo y errores humanos.",
      color: "from-purple-500 to-pink-500",
    },
    {
      icon: <Target className="w-6 h-6" />,
      title: "Escalabilidad",
      description: "Tecnología que crece con tu negocio sin frenar la operación.",
      color: "from-orange-500 to-red-500",
    },
    {
      icon: <Users className="w-6 h-6" />,
      title: "Mejor experiencia de cliente",
      description: "Respuestas rápidas, personalizadas y disponibles 24/7.",
      color: "from-indigo-500 to-purple-500",
    },
    {
      icon: <Sparkles className="w-6 h-6" />,
      title: "Mayores ventas",
      description: "Sistemas de búsqueda de clientes que escalan tus ventas.",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            <p className="text-lg text-muted-foreground leading-relaxed">
              <strong className="text-white">GenAI Partners no es solo un proveedor de tecnología:</strong> somos tu
              socio estratégico en transformación digital impulsada por inteligencia artificial.
            </p>
            <p className="text-base text-muted-foreground leading-relaxed">
              Nos involucramos profundamente en tu negocio para{" "}
              <strong className="text-emerald-400">reimaginarlo, digitalizarlo y potenciarlo</strong>, integrando IA en
              cada etapa clave.
            </p>
            <p className="text-base text-muted-foreground leading-relaxed">
              Nuestro enfoque combina <strong className="text-blue-400">automatización inteligente</strong>,{" "}
              <strong className="text-cyan-400">optimización de procesos</strong> y{" "}
              <strong className="text-purple-400">ecosistemas digitales integrados</strong>, conectando marketing,
              ventas y operaciones en un flujo único, eficiente y escalable.
            </p>
          </div>
        </motion.div>
          ...
          {benefits.map((benefit, index) => (
            ...
            >
              <div className="h-full rounded-2xl border border-border/50 bg-background/50 backdrop-blur-sm overflow-hidden hover:border-primary/50 transition-all duration-500 hover:shadow-[0_0_30px_rgba(52,211,153,0.15)] p-6">
                {/* Icon */}
                <div
                  className={`inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-br ${benefit.color} text-white mb-4 group-hover:scale-110 transition-transform duration-300`}
                >
                  {benefit.icon}
                </div>
                ...
                {/* Gradient overlay */}
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${benefit.color} opacity-5 group-hover:opacity-10 transition-opacity duration-500 rounded-2xl`}
                ></div>
              </div>
            </motion.div>
          ))}
        ...
        >
          <div className="bg-gradient-to-r from-emerald-500/10 to-green-500/10 border border-emerald-500/20 rounded-2xl p-8 max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-emerald-400 mb-4">El resultado:</h3>
            <p className="text-lg text-foreground leading-relaxed">
              <strong>Menos tareas manuales, más control estratégico y un ROI tangible en el corto plazo</strong>, con
              tecnología preparada para escalar al ritmo de tu negocio.
            </p>
          </div>
        </motion.div>
      </div>
