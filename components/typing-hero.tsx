...
export function TypingHero() {
  ...
  const phrases = [
    { text: "automatización inteligente", color: "text-emerald-400", cursorColor: "bg-emerald-400" },
    { text: "soluciones con IA", color: "text-blue-400", cursorColor: "bg-blue-400" },
    { text: "transformación digital", color: "text-orange-400", cursorColor: "bg-orange-400" },
  ]

  const baseText = "Impulsamos tu negocio con "
